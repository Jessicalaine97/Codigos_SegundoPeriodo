...
select nome_cliente, cpf, rg
from cliente
where bairro = 'Centro';

select nome_cliente, rua
	from cliente
	where cidade='São Paulo' or datanasc>'1990-01-01'; 
    
select codigo_cliente
	from cliente
	where telefone is not null and datanasc is null; 

select codigo_imovel
	from imovel
	where codigo_tipo is not null ; 
    
select codigo_imovel, descricao
from imovel
Where bairro='Centro' and cidade='Juiz de Fora' ; 

select codigo_imovel, descricao
from imovel
Where cidade= 'Rio de Janeiro' or cidade='Petrópolis'; 

select nome_proprietario, cpf
from proprietario
Where nome_proprietario='João' and sobrenome='da Silva'; 

/*Quando nao retormar nada é melhor conferir!*/
...
Select *
from venda
Where valor='150000,00'; 

Select *
from venda
Where valor>='100000' and valor<='200000'; 

/*OU*/
/*Between inclui as faixas*/
/*NAO colocar . em numeros*/
...
Select descricao /*d*/
From imovel as i, tipo_imovel as ti /*se tirar o as da no mesmo*/
Where tipo='Apartamento' and i.codigo_tipo = ti.codigo_tipo;
/* Where tipo='Apartamento' and imovel.codigo_tipo=tipo_imovel.codigo_tipo */

/*Se eu quiser todas as colunas de uma tabela so: coloca Select i.* */

Select nome_cliente, valor
From cliente as c, venda as v
Where c.codigo_cliente = v.codigo_cliente;

Select nome_proprietario, descricao
From proprietario as p, imovel as i, imovel_proprietario as pi
Where p.codigo_proprietario = pi.codigo_proprietario and i.codigo_imovel = pi.codigo_imovel;

Select valor, nome_proprietario, bairro
From venda as v, proprietario as p, imovel as i
Where bairro = 'Centro' and v.codigo_imovel = i.codigo_imovel;
